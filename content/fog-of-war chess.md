...
Fog-of-war chess is by far, my favorite game in the world. Fog-of-war is a variant of chess (available on [chess.com](https://www.chess.com/variants/fog-of-war)) where you are only able to see the squares your pieces are or where your pieces can move. That is, at the start of the game, you can see your half of the board (your pieces on the first two rows, and the next two rows, to which your pawns and knights can move), and nothing else. As the game progresses and the position opens up, you can begin to see more of the board, and by the endgame, you may again not be able to see much of the board, as you simply have fewer pieces on the board. 

![fow.png|424](assets/fow_1728409382048_0.png)

I first tried playing in early 2020 and became heavily invested (some have said [[addiction|addicted]]) over the course of quarantine.
# Bots
There are so so so many great things about it, including that ~~it's very much unsolved—there don't even exist superhuman bots for this game~~computers remained sub-human at the game until June 2025. Why did it take so long to create bots that can play fog-of-war chess well? Many reasons:
...
# Deviants
## Botez Gambit Fog-of-War
Inspired by a friend, I tried playing ~100 games sacking a queen in the first few moves. (Botez Gambit Fog-of-War). I'll expand on the results of this experiment in a bit.
## Unilateral Fog-of-War
I've started to try to play normal blitz where I am bound by the fog and my opponent isn't. I call this Unilateral Fog-of-War. It's very hard, but I'm getting better. I think my unilateral ELO is ~650. 
