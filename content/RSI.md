...
For the stronger definition of RSI, which requires that humans are completely out of the loop of AI development, this is not RSI. However, this company would still move much, much faster than the human-run one. Specifically, it would move closer to the upper bound of the rate of progress than human-run AI companies would.

[This post](https://www.planned-obsolescence.org/p/six-milestones-for-ai-automation) from Ajeya Cotra offers a response to this claim, I think. Basically, it says that there are relevant milestones before you get to the point of "a fully automated company that hires out some human labor" (which she would refer to as AI research supremacy without AI production supremacy). The relevant milestones are adequacy, at which point AIs *can* do AI research / production without humans and parity, at which point the slowdown from removing humans or AIs is the same. 
## Pure-software
...
I think this gets at a clear or an interesting dynamic where the parts of AI R&D that get automated immediately compress to small parts (in terms of time). As Tyler Cowen says, all the other parts become the bottlenecks. The human-run parts become the bottlenecks. The rate of progress increases sharply as a result of the automation and then quickly hits some barrier because of the next thing that is not yet automated.
